                        ...
                        <div class="col-lg-8" >
                            <div class="main-navigation flex-lg-right">
                                <ul class="main-menu menu-right ">
                                    ...
                                    echo '
                                        <li class="menu-item"><a href="donhang.php">Bình luận</a></li>
                        ...
                        <div class="col-lg-5">
                            <div class="header-search-block">
								<form action="search.php" method="GET">
             					<input type="text" name="search" placeholder="Bạn nhập từ khoá và để MeowShop lo">
                ...
                <div class="off-canvas-inner">
                    ...
                    <div class="mobile-navigation">
                        ...
                        <div class="off-canvas-bottom">
                            ...
                            <a href="#" class="sin-contact"><i class="fas fa-mobile-alt"></i>0915 970 687</a>
                            <a href="#" class="sin-contact"><i class="fas fa-envelope"></i>dqvinh.19it2@vku.udn.vn</a>
                        </div>
