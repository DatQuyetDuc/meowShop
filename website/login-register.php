					...
					<div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb--30 mb-lg--0">
						...
						<form action="login-register.php" method="POST">
							<div class="login-form">
								<h4 class="login-title">Tạo tài khoản mới</h4>
								<p><span class="font-weight-bold">Tạo tài khoản để mua truyện, bình luận và nhiều hơn thế nữa</span></p>
								<div class="row">
									<div class="col-md-12 col-12 mb--15">
										<label for="email">Tên đăng nhập</label>
										<input class="mb-0 form-control" type="text"  name="tendn" value="<?php echo $tendn; ?>" placeholder="Nghĩ ra một tên thật ngầu nào ~.~ ">
										<?php echo $usernameErr ?>
									</div>
									<div class="col-12 mb--20">
										<label for="email">Email</label>
										<input class="mb-0 form-control" type="email" name="email" value="<?php echo $email; ?>"  placeholder="Nhập email ở đây nhé">
										<?php echo $emailer ?>
									</div>
									<div class="col-lg-6 mb--20">
										<label for="password">Mật khẩu</label>
										<input class="mb-0 form-control" type="password" name="matkhau"  placeholder="Nhập mật khẩu">
										<?php echo $PasswordErr ?>
									</div>
									<div class="col-lg-6 mb--20">
										<label for="password">Nhập lại mật khẩu</label>
										<input class="mb-0 form-control" type="password" name="matkhau1"  placeholder="Nhập lại mật khẩu ở đây">
										<?php echo $PasswordErr1 ?>
									</div>
									<div class="col-md-12">
										<input style="background-color: #33CC33" type="submit" name="" value="Đăng ký" class="btn btn-outlined">
									</div>
								</div>
							</div>
						</form>
