										...
										echo '<tr>';
											...
											<tr>';
												echo'<td colspan="6" class="actions">
														<input  type="submit" class="btn btn-outlined" name="submit" value="UPDATE"> 
														<button  class="btn btn-outlined"  value="Mua Tiếp"><a href="index.php">Mua tiếp<a></button>
														<button  class="btn btn-outlined"  value="Thanh toán"><a href="checkout.php?idsp='.$str.'">Đặt hàng<a></button>									
												</td>';
											echo'</tr>';	
								}
										?>
